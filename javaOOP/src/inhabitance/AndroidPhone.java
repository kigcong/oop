...
public class AndroidPhone extends Iphone {
	...
	@Override            //동일한 os(메소드)가 있는 경우 부모껄 쓰지 않고 자신의 것을 사용 
	public String getOs() {
		//super.getos();
		return os;
	}

	@Override              //같은 메소드가 있을경우 오버라이드 부터 사용을 하라는 표시 
	...
	public void setData(String name, String data) {
		...
		this.data = super.getCompany() + "\t" + super.getCall() + "\t" + this.getOs() + "\t" + data + ":카톡메세지 전달";
	}
