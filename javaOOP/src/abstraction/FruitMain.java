...
public class FruitMain {
	public static void main(String[] args) {
		/*
		 ★★★ 인터페이스는 객체를 만들 수 없다.  오직 클래스만 사용 가능 
		 FruitInterface f = new f......();
		 [중요문법]
		 인터페이스를 구현한 클래스의 객체생성은 인터페이스명(타입) 인스턴스 = new 생성자();
		 * */
		...
		이처럼 하는 이유는 기획자(아키텍처) 가 일선 개발자들이 자기 마음대로 메소드를 선언하여 기획자 의도에 벗어나는 것을 막고
